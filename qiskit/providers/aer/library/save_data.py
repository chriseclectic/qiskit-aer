...
class SaveData(Instruction):
    ...
    def __init__(self, data, key, num_qubits, subtype='single', params=None):
        ...
        super().__init__("save", num_qubits, 0, params)
...
class SaveAverageData(SaveData):
    ...
    def __init__(self,
        ...
        if conditional:
            subtype = 'c_' + subtype
        super().__init__(data, key, num_qubits, subtype=subtype, params=params)
