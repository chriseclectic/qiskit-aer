...
const cvector_t VMatrix::I = Linalg::vectorize_matrix(Matrix::I);

const cvector_t VMatrix::X = Linalg::vectorize_matrix(Matrix::X);

const cvector_t VMatrix::Y = Linalg::vectorize_matrix(Matrix::Y);

const cvector_t VMatrix::Z = Linalg::vectorize_matrix(Matrix::Z);

const cvector_t VMatrix::S = Linalg::vectorize_matrix(Matrix::S);

const cvector_t VMatrix::SDG = Linalg::vectorize_matrix(Matrix::SDG);

const cvector_t VMatrix::T = Linalg::vectorize_matrix(Matrix::T);

const cvector_t VMatrix::TDG = Linalg::vectorize_matrix(Matrix::TDG);

const cvector_t VMatrix::H = Linalg::vectorize_matrix(Matrix::H);

const cvector_t VMatrix::X90 = Linalg::vectorize_matrix(Matrix::X90);

const cvector_t VMatrix::CX = Linalg::vectorize_matrix(Matrix::CX);

const cvector_t VMatrix::CZ = Linalg::vectorize_matrix(Matrix::CZ);

const cvector_t VMatrix::SWAP = Linalg::vectorize_matrix(Matrix::SWAP);
